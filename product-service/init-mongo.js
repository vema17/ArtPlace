...
db.products.insertOne({
  ...
  fecha_publicacion: new Date("2024-05-18"),
...
db.products.insertOne({
  ...
  artista: "Javier Ruiz",
  fecha_publicacion: new Date("2024-06-07"),
...
db.products.insertOne({
  ...
  fecha_publicacion: new Date("2024-07-12"),
...
db.products.insertOne({
  ...
  fecha_publicacion: new Date("2024-08-24"),
...
db.products.insertOne({
  ...
  fecha_publicacion: new Date("2024-10-15"),
...
db.products.insertOne({
  ...
  artista: "Sofía Ruiz",
  fecha_publicacion: new Date("2024-11-10"),
